...
6. Run `.orc/agent_tools/share/get_task.py <task-filename>` to fetch the full task description and the conversation (any prior review comments). This is always required before you start reviewing.
