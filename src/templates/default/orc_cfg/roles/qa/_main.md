...
5. The **Board** section in your shared context — find the task under review in `open`; read the `comments` for prior context and the corresponding task `.md` for the full step list.
