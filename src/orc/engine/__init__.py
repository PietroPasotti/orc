"""orc.engine — orchestration engine subpackage.

Submodules:
- :mod:`orc.engine.dispatcher`   — poll-based parallel agent scheduler
- :mod:`orc.engine.pool`         — agent process pool and lifecycle
- :mod:`orc.engine.workflow`     — high-level workflow routing
